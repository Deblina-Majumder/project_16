...
function preload(){
  ...
  sunImage=loadAnimation("sun1.png","sun2.png","sun3.png");
}
...
function createBirds(){
 bird=createSprite(0,Math.round(random(20,140)),50,50);
...
function createSun(){
  sun=createSprite(30,30,30,30);
  sun.addAnimation("running",sunImage);
  sun.scale=0.04;
